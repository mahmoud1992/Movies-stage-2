...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDb = AppDatabase.getInstance (DetailActivity.this);
        ...
        protected void onPostExecute(final String temp) {
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (temp == null) {
                        Toast.makeText(DetailActivity.this ,Constants.NO_TRAILERS, Constants.TOAST_DURATION).show();
                    } else {
                        watchYoutubeVideo (DetailActivity.this, temp);
                    }
                }
            });
    ...
    private class ReviewsAsyncTask extends AsyncTask<String, Void, Movie[]> {
        ...
        protected void onPostExecute(Movie[] movies) {
            // specify an adapter
            mReviewAdapter = new ReviewAdapter(movies, DetailActivity.this);
